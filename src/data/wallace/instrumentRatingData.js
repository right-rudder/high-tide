...
const instrumentRatingSouthport = {
  ...
  description: [
    ...
    "Earning an Instrument Rating in Wallace significantly expands a pilot’s skill set, enabling them to safely and confidently operate aircraft in nearly all weather conditions. This certification is a crucial step for any pilot aspiring to advance their career in aviation, whether for personal, business, or professional opportunities in the Wallace, NC, area and beyond.",
  ],
};
