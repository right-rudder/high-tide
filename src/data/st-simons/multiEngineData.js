...
const multiEngineSouthport = {
  ...multiEngine,
  title: "Multi Engine Training in St Simons Island, GA | High Tide Aviation",
  siteDescription:
    "Advance your aviation career with Multi-Engine Training in St. Simons Island, GA, at High Tide Aviation. Our hands-on program offers training in multi-engine aircraft, including engine management and emergency protocols, all while flying over the scenic Georgia coast. Equip yourself with the skills to confidently operate aircraft in diverse conditions with our expert instructors in St. Simons Island.",
  description: [
