  ...
  const brokerageServices = [
    {
      ...
      description: [
        "Complete a simple application and get pre-approved in just minutes with a soft credit inquiry that won’t impact your credit score.",
      ],
      icon: IoMdStopwatch,
    },
    {
      ...
      description: [
        "Choose repayment plans of up to 60 months, allowing you to manage your finances while pursuing your aviation goals.",
      ],
      icon: SlDocs,
    },
    {
      title: "No Cosigner Required",
      description: ["With a credit score of 550+, no cosigner is needed."],
      icon: VscPreview,
    },
  ];
