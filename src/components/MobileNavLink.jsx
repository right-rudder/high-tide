  ...
  return (
    <div className="flex flex-col items-start border-t border-white/30 last:border-b">
      ...
      <a
        ...
        target="_blank"
        className="hidden lg:flex border-white/20 border-r text-xs 2xl:text-base tracking-widest uppercase font-semibold md:px-6 ml-2 px-5.5 py-2.5 shadow-none w-auto rounded text-center px-3 transition duration-200 bg-mustard-yellow hover:bg-white text-dark-blue border-mustard-yellow filter "
      >
        Aerial Tours
      </a>
    </div>
